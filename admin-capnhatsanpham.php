        ...
        ?>
                    <div class="col-md-4">
                        <h4 align="center">Cập nhật sản phẩm</h4><br>
                            <form action="admin-capnhatsanpham.php" method="POST" enctype="multipart/form-data">
                                <label>Name</label>
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><a href="admin-capnhatsanpham.php?quanly=capnhat&capnhat_id=<?php echo $row_sp['ID']?>">Cập nhật</a> || <a href="?xoa=<?php echo $row_sp['ID']?>">Xóa</a></td>
                            </tr>
                            <?php
                            }
                            ?>
