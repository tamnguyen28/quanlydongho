...
if (isset($_POST['thanhtoan'])) {
	...
	$amount = "10000";
	$orderId = time() . "";
	$returnUrl = "http://localhost:8080/quanlydongho/donhang.php?ghidata=1&name=$name&phone=$phone&address=$address&note=$note&email=$email&giaohang=$giaohang&idcustomer=$idcustomer";
