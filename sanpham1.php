<div class="tab-content">
    <div class="tab-pane active" id="th">
        ...
        $result = mysqli_query($conn, "SELECT * FROM product limit 35, 12"); //lấy dữ liệu ra lưu vào biến result
        $arrtemp = array(); // 
                        ...
                        <div class="product-wrapper mb-40">
                            <div class="product-img">
                                <a href="product-details.php?idproduct=<?php echo $arrtemp[$k]['ID'] ?>">
                                    <img src="public/frontend/img/donghonam/<?php echo $arrtemp[$k]['Image']; ?>" alt="book" class="primary" />
                                </a>
    ...
    <div class="tab-pane fade" id="list">
        ...
        <div class="single-shop mb-30">
            <?php
            $result = mysqli_query($conn, "SELECT * FROM product limit 44, 3");
                        ...
                        <div class="product-wrapper-2">
                            <div class="product-img">
                                <a href="product-details.php?idproduct=<?php echo $row['ID'] ?>">
                                    <img src="public/frontend/img/donghonam/<?php echo $row['Image']; ?>" alt="book" class="primary" />
                                </a>
                            </div>
                        </div>
                    </div>
